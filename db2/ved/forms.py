...
class SearchForm(forms.Form):
    search_string = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control','id':'txtSearch','width':'500px','autofocus':'yes','placeholder': 'Введите текст'}), max_length=100)
